...
function spawnWishMessage() {
	...
	const isMobile = window.innerWidth <= 768;
	const minX = isMobile ? 10 : 15; // Mobile: rộng hơn một chút
	const maxX = isMobile ? 90 : 85;
...
function spawnWishImage() {
	...
	// Vị trí ngang ngẫu nhiên (khác với câu chúc một chút) - responsive cho mobile
	const isMobile = window.innerWidth <= 768;
	const minX = isMobile ? 5 : 10; // Mobile: rộng hơn
